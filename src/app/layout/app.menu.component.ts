    ...
    ngOnInit() {
        this.model = [
                ...
                items: [
                    {
                        ...
                        routerLink: ['/millManagement/dashboard']
                    },
                    // {
                    //     label: 'Banking',
                ...
                items: [
                    {
                        ...
                        routerLink: ['arrival/mill_arrival']
                    },
                    {
                        label: 'View Mill Deposit',
                        icon: 'pi pi-fw pi-arrow-circle-right',
                        routerLink: ['arrival/view_mill_arrival']
                    }
            ...
            },
            {
                ...
                items: [
                    {
                        label: 'Mill Withdrawal',
                        icon: 'pi pi-fw pi-arrow-circle-left',
                        routerLink: ['dispatch/mill_dispatch']
                    }
                ...
                items: [
                    {
                        ...
                        routerLink: ['registration/member_profile']
                    },
                    {
                        label: 'User Creation',
                        icon: 'pi pi-fw pi pi-user',
                        routerLink: ['registration/user_master']
                    },
                ...
                items: [
                    {
                        ...
                        routerLink: ['master-pages/mill']
                    },
                    {
                        label: 'User Mill Mapping',
                        icon: 'pi pi-fw pi-cog',
                        routerLink: ['master-pages/user-mill-mapping']
                    },
                    // {
                    //     label: 'Center Warehouse',
                    //     icon: 'pi pi-fw pi-cog',
                    //     routerLink: ['master-pages/center-wh']
                    // },
                    {
                        label: 'Commodity',
                        icon: 'pi pi-fw pi-circle-fill',
                        routerLink: ['master-pages/commodity']
                    },  
                    {
                        label: 'Season Creation',
                        icon: 'pi pi-fw pi-database',
                        routerLink: ['master-pages/season']
                    },           
                    {
                        label: 'Commodity Conversion',
                        icon: 'pi pi-fw pi-arrow-right-arrow-left',
                        routerLink: ['master-pages/commodity-conv']
                    }            
